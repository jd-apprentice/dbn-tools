...
RUN apt-get update
RUN apt-get install -y --no-install-recommends wget=1.21.2-2ubuntu1 git=1:2.34.1-1ubuntu1.6 curl=7.81.0-1ubuntu1.7 net-tools=1.60+git20181103.0eebece-1ubuntu5 python3-dev python3-pip
